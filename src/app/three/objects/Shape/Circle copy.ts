...
export class Circle {
	...
	constructor(radius: number) {
		...
		this.geometry = new THREE.TorusGeometry(this.radius, this.radius / 50.0, 10, 50);
	...
	public getMesh(): any {
		...
		for (let i = 0; i < 10; i++) {
			this.mesh.rotation.x = Math.PI / i;
			this.mesh.rotation.y = Math.PI / i;
			circleGroup.add(this.mesh);
		}
		return circleGroup;
	}
