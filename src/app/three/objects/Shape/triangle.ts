...
export class triangle {
    ...
    constructor(height: number, radius: number,radiusSegments: number) {
        this.geometry = new THREE.ConeGeometry(height, radius, radiusSegments);
        this.material = new THREE.ShaderMaterial({
            ...
            fragmentShader: `
                ...
                void main() {
                    ...
                    gl_FragColor = vec4(0.1, color.y, 0.4, 1.0);
                }
            `,
            uniforms: {
                time: { value: 0.0 },
